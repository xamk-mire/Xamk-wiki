...
This file contains comprehensive code examples for unit testing with xUnit.

## Table of Contents

1. [Basic Assert Examples](#basic-assert-examples)
2. [Theory and InlineData](#theory-and-inlinedata)
3. [Mocking with Moq](#mocking-with-moq)
4. [Async Tests](#async-tests)
5. [Exception Tests](#exception-tests)
6. [Collection Tests](#collection-tests)
7. [Comprehensive Example: UserService](#comprehensive-example-userservice)
...
### Example 1: Parameterized Calculator Tests
...
public class CalculatorTheoryTests
{
    ...
    public void Divide_VariousInputs_ReturnsQuotient(int a, int b, double expected)
    {
        ...
        // Assert
        Assert.Equal(expected, result, 3); // 3 decimal precision
    }
...
public class UserServiceTests
{
    ...
    public void CreateUser_ValidData_SavesUserAndSendsEmail()
    {
        ...
        emailServiceMock.Verify(x => 
            x.SendWelcomeEmail("john@example.com", "John"), 
            Times.Once);
    }
...
This example combines all learned concepts.
...
Return to theory: [Unit-Testing.md](Unit-Testing.md)
